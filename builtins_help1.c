...
/**
 * help_alias - displays info on the shellby builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - displays info on the shellby builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - displays info on the shellby builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - displays info on the shellby builtin command 'help'.
 */
void help_help(void)
{
